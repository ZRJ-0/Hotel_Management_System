            ...
            <c:forEach items="${oneMenuList}" var="oneMenu">
                <dd>
                    <div class="title"><span><img
                            src="<%=basePath %>/static/images/leftico03.png"/></span>${oneMenu.oneName}</div>
                    <ul class="menuson">
                        <c:forEach items="${oneMenu.twoMenuList}" var="twoMenu">
                            <li>
                                <div class="header"><cite></cite> <a href="<%=basePath %>/${twoMenu.url}"
                                                                     target="rightFrame">${twoMenu.twoName}</a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
