...
<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            $(function () {
                $('#pagination').bootstrapPaginator({
                    ...
                    pageUrl: function (type, page, current) {
                        return 'getSystemUserByLimit.do?pageNum=' + page;
                    },
    ...
    <body>
        <div class="place"><span>位置：</span>
            <ul class="placeul">
                <li><a href="<%=basePath %>/pages/main.jsp">首页</a></li>
                <li><a href="#">用户管理</a></li>
            ...
            <table class="tablelist">
                ...
                <c:forEach items="${pageInfo.list}" var="map" varStatus="num">
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${map.is_admin == 1}"><a href="javascript:void(0)">无操作</a></c:when>
                                <c:otherwise>
                                    <a href="<%=basePath %>/updateSystemUserStatus.do?userId=${map.id}&flag=${map.use_status== '1'?'0' : '1'}">${map.use_status == '1' ? '禁用' : '启用'}</a>
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>
